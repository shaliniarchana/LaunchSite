...
export default function AboutPage() {
  ...
  ['fas fa-wind', 'text-teal-300', 'Tailwind CSS'],
  ['fab fa-bootstrap', 'text-purple-500', 'Bootstrap'],
  ['fas fa-wave-square', 'text-pink-300', 'Framer Motion'],
  ['fas fa-cube', 'text-rose-400', 'shadcn/ui'],
  ['fab fa-npm', 'text-red-500', 'NPM'],
  ['fab fa-node-js', 'text-green-500', 'Node.js'],
  ['fab fa-java', 'text-red-600', 'Java'],
  ['fas fa-hashtag', 'text-indigo-400', 'C#'],
  ['fas fa-terminal', 'text-gray-400', 'Express.js'],
  ['fas fa-database', 'text-yellow-500', 'MySQL'],
  ['fab fa-php', 'text-indigo-400', 'PHP'],
  ['fab fa-git-alt', 'text-orange-400', 'Git'],
  ['fab fa-fire', 'text-orange-300', 'Firebase'],
  ['fas fa-lock', 'text-red-300', 'Firebase Auth'],
  ['fas fa-cloud-upload-alt', 'text-blue-300', 'Firebase Hosting'],
  ['fab fa-windows', 'text-blue-400', 'WAMP Server'],
['fas fa-database', 'text-green-500', 'Supabase'],
  ['fas fa-globe', 'text-green-400', 'Vercel'],
  ['fas fa-laptop-code', 'text-blue-500', 'C'],
  ['fas fa-microchip', 'text-gray-500', 'C++'],
  ['fab fa-windows', 'text-blue-400', 'Windows API'],
